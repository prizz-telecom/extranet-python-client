...
class TransitionFormFieldsInner(BaseModel):
    """
    ...
    values: Optional[List[TransitionFormFieldsInnerValuesInner]] = None
    type: Optional[StrictStr] = None
    help: Optional[StrictStr] = None
    multiple: Optional[StrictBool] = None
    expanded: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["caption", "name", "required", "value", "values", "type", "help", "multiple", "expanded"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value"),
            "values": [TransitionFormFieldsInnerValuesInner.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None,
            "type": obj.get("type"),
            "help": obj.get("help"),
