...
class CommentThread(BaseModel):
    ...
    subscribers: Optional[List[StrictStr]] = None
    comments: Optional[List[CommentTree]] = None
    __properties: ClassVar[List[str]] = ["id", "createDate", "lastModifiedDate", "owner", "title", "entityClass", "entityId", "public", "subscribers", "comments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comments": [CommentTree.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None
        })
        return _obj
