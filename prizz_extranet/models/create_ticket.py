...
class CreateTicket(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["numero", "ticket_id", "running_process"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if running_process (nullable) is None
        # and model_fields_set contains the field
        if self.running_process is None and "running_process" in self.model_fields_set:
            _dict['running_process'] = None
