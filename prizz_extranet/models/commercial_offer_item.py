...
class CommercialOfferItem(BaseModel):
    ...
    price_list_item: Optional[PriceListItem] = Field(default=None, alias="priceListItem")
    __properties: ClassVar[List[str]] = ["availableWorkflows", "id", "name", "unitPrice", "unitPriceStr", "unit", "vat", "recurrence", "unitPriceDiscount", "unitPriceDiscountStr", "quantity", "houseNumber", "houseNumberComplement", "streetName", "postalCode", "cityName", "inseeCode", "latitude", "longitude", "x", "y", "projection", "price", "sectionId", "commercialOfferId", "priceStr", "vatRate", "commercialCode", "description", "toEstimate", "priceListItem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of price_list_item
        if self.price_list_item:
            _dict['priceListItem'] = self.price_list_item.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "priceListItem": PriceListItem.from_dict(obj["priceListItem"]) if obj.get("priceListItem") is not None else None
        })
        return _obj
