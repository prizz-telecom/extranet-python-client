...
class GetWorkflowRedirect(BaseModel):
    """
    GetWorkflowRedirect
    """ # noqa: E501
    object_class: Optional[StrictStr] = Field(default=None, alias="objectClass")
    object_id: Optional[StrictInt] = Field(default=None, alias="objectId")
    __properties: ClassVar[List[str]] = ["objectClass", "objectId"]
