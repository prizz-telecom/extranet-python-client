...
class Attachment(BaseModel):
    ...
    presigned_url_expires: Optional[datetime] = Field(default=None, alias="presignedUrlExpires")
    __properties: ClassVar[List[str]] = ["id", "name", "createDate", "lastModifiedDate", "category", "mimeType", "presignedUrl", "presignedUrlExpires"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if presigned_url_expires (nullable) is None
        # and model_fields_set contains the field
        if self.presigned_url_expires is None and "presigned_url_expires" in self.model_fields_set:
            _dict['presignedUrlExpires'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "presignedUrlExpires": obj.get("presignedUrlExpires")
        })
        return _obj
