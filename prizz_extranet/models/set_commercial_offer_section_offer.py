...
class SetCommercialOfferSectionOffer(BaseModel):
    """
    SetCommercialOfferSectionOffer
    """ # noqa: E501
    offer_id: Optional[StrictInt] = Field(default=None, alias="offerId")
    eligibility: Optional[SetCommercialOfferSectionOfferEligibility] = None
    __properties: ClassVar[List[str]] = ["offerId", "eligibility"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eligibility": SetCommercialOfferSectionOfferEligibility.from_dict(obj["eligibility"]) if obj.get("eligibility") is not None else None
        })
        return _obj
