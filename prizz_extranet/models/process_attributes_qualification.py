...
class ProcessAttributesQualification(BaseModel):
    """
    ProcessAttributesQualification
    """ # noqa: E501
    values: Optional[ProcessAttributesQualificationValues] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": ProcessAttributesQualificationValues.from_dict(obj["values"]) if obj.get("values") is not None else None
        })
        return _obj
