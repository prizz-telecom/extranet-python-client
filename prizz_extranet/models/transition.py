...
class Transition(BaseModel):
    ...
    form_fields: Optional[List[TransitionFormFieldsInner]] = Field(default=None, alias="formFields")
    __properties: ClassVar[List[str]] = ["name", "html", "formFields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "html": obj.get("html"),
            "formFields": [TransitionFormFieldsInner.from_dict(_item) for _item in obj["formFields"]] if obj.get("formFields") is not None else None
        })
        return _obj
