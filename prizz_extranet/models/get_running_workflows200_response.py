...
class GetRunningWorkflows200Response(BaseModel):
    """
    GetRunningWorkflows200Response
    """ # noqa: E501
    workflows: Optional[List[GetRunningWorkflows200ResponseWorkflowsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workflows": [GetRunningWorkflows200ResponseWorkflowsInner.from_dict(_item) for _item in obj["workflows"]] if obj.get("workflows") is not None else None
        })
        return _obj
