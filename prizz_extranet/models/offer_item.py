...
class OfferItem(BaseModel):
    ...
    eligibility_string: Optional[StrictStr] = Field(default=None, alias="eligibilityString")
    __properties: ClassVar[List[str]] = ["id", "name", "createDate", "lastModifiedDate", "minCount", "maxCount", "product", "eligibilityString"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if eligibility_string (nullable) is None
        # and model_fields_set contains the field
        if self.eligibility_string is None and "eligibility_string" in self.model_fields_set:
            _dict['eligibilityString'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eligibilityString": obj.get("eligibilityString")
        })
        return _obj
