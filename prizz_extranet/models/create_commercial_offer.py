...
class CreateCommercialOffer(BaseModel):
    """
    CreateCommercialOffer
    """ # noqa: E501
    legal_entity_id: Optional[StrictInt] = Field(default=None, alias="legalEntityId")
    client_legal_entity_id: Optional[StrictInt] = Field(default=None, alias="clientLegalEntityId")
    __properties: ClassVar[List[str]] = ["legalEntityId", "clientLegalEntityId"]
