...
class CommentTree(BaseModel):
    ...
    children: Optional[List[CommentTree]] = None
    __properties: ClassVar[List[str]] = ["comment", "children"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "children": [CommentTree.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
CommentTree.model_rebuild(raise_errors=False)
