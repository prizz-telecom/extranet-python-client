...
class TestTypedContact(unittest.TestCase):
    """TypedContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypedContact:
        """Test TypedContact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypedContact`
        """
        model = TypedContact()
        if include_optional:
            return TypedContact(
