...
class TestAppointmentServiceContract(unittest.TestCase):
    """AppointmentServiceContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppointmentServiceContract:
        """Test AppointmentServiceContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppointmentServiceContract`
        """
        model = AppointmentServiceContract()
        if include_optional:
            return AppointmentServiceContract(
                available_workflows = [
    ...
    def testAppointmentServiceContract(self):
        """Test AppointmentServiceContract"""
