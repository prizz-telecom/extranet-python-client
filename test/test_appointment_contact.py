...
class TestAppointmentContact(unittest.TestCase):
    """AppointmentContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppointmentContact:
        """Test AppointmentContact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppointmentContact`
        """
    ...
    def testAppointmentContact(self):
        """Test AppointmentContact"""
