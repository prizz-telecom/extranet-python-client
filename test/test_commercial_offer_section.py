...
class TestCommercialOfferSection(unittest.TestCase):
    """CommercialOfferSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommercialOfferSection:
        """Test CommercialOfferSection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommercialOfferSection`
        """
        model = CommercialOfferSection()
        if include_optional:
            return CommercialOfferSection(
                available_workflows = [
    ...
    def testCommercialOfferSection(self):
        """Test CommercialOfferSection"""
