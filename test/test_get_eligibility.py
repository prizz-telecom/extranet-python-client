...
class TestGetEligibility(unittest.TestCase):
    """GetEligibility unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEligibility:
        """Test GetEligibility
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEligibility`
        """
        model = GetEligibility()
        if include_optional:
