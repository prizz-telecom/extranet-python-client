...
*DefaultApi* | [**get_commercial_offer_by_name**](docs/DefaultApi.md#get_commercial_offer_by_name) | **GET** /external-api/v2/commercial_offers_by_name/{offer_name} | Commercial Offer
